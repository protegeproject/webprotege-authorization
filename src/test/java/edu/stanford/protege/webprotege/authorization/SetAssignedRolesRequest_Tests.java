...
import edu.stanford.protege.webprotege.authorization.SetAssignedRolesRequest;
...
class SetAssignedRolesRequest_Tests {
    ...
    void shouldSupplyChannelName() {
        assertThat(request.getChannel()).isEqualTo("webprotege.authorization.SetAssignedRoles");
    }
